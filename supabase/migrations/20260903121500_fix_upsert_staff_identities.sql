-- ============================================================
-- fix 2b: upsert_staff must also create auth.identities rows.
-- In GoTrue v2+, a user without a matching auth.identities row
-- ("provider" = 'email') cannot sign in with a password.
-- The auth.identities "email" column is GENERATED from
-- identity_data->>'email', so it must NOT be written directly.
-- ============================================================
